...
// if (address != null && address.isNotEmpty) {
//   try {
//     // Debugging: Print address to ensure it's being passed correctly
//     print('Address: $address');

//     // Adding 'address' field to 'users' collection document
//     await FirebaseFirestore.instance.collection('users').doc(user.uid).set({
//       'address': address,
//     }, SetOptions(merge: true)); // Merge to preserve existing data

//     // Adding 'address' field to 'customer' collection document
//     await FirebaseFirestore.instance.collection('customer').doc(user.uid).set({
//       'address': address,
//     }, SetOptions(merge: true)); // Merge to preserve existing data
